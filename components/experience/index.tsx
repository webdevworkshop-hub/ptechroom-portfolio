      ...
      <div className="container mx-auto w-fit px-4 ">
        ...
        <div className="grid mt-10  gap-5">
          {EXPERIENCE_DATA.map((experience) => (
            <div
              key={experience.id}
              className="bg-background p-6 rounded-lg drop-shadow-lg max-w-4xl grid md:grid-cols-[1fr_auto] gap-4"
              style={{
                background:
                  "linear-gradient(90deg, #111827 0%, rgba(0, 0, 0, 0.6) 100%)",
              }}
            >
              {/* Info Section */}
              ...
              <div className=" flex flex-col items-center justify-center gap-4">
                ...
                <Link
                  ...
                  target="_blank"
                  className="text-xl font-bold text-primary-foreground hover:text-primary-foreground/80 transition-colors"
                >
