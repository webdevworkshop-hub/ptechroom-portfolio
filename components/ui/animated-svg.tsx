      ...
      >
        ...
        <g>
          <circle
            ...
            cy="60"
            r="1.5"
            className="fill-primary flow-dots dot-1"
          />
          <circle
            cx="16"
            cy="70"
            r="1.5"
            className="fill-primary flow-dots dot-2"
          />
          <circle
            cx="16"
            cy="80"
            r="1.5"
            className="fill-primary flow-dots dot-3"
          />
          <circle
            cx="16"
            cy="90"
            r="1.5"
            className="fill-primary flow-dots dot-4"
          />
          <circle
            cx="16"
            cy="100"
            r="1.5"
            className="fill-primary flow-dots dot-5"
          />
          <circle
            cx="16"
            cy="110"
            r="1.5"
            className="fill-primary-foreground flow-dots dot-6"
          />
          <circle
            cx="16"
            cy="120"
            r="1.5"
            className="fill-primary-foreground flow-dots dot-7"
          />
          <circle
            cx="16"
            cy="130"
            r="1.5"
            className="fill-primary-foreground flow-dots dot-8"
          />
        </g>
