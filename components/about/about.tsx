      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="grid md:grid-cols-2 gap-10  mx-auto max-w-7xl relative -top-20 justify-between">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2 text-foreground/80 leading-relaxed text-sm">
              <p>
                Hi, I&apos;m  a 
                <span className="text-primary-foreground font-medium text-lg "> Frontend Developer</span> passionate about
              ...
              <p>
                ...
                <span className="italic">delightful to use . One last thing, I&apos;m available for freelance work, so feel free to reach out and say hello! I promise I don&apos;t bite </span> 😉.
              </p>
            </div>
          </div>

          <div className="flex justify-center">
            <Image src="/about/about-me.png" alt="About" width={400} height={400} className="rounded-2xl shadow-lg border-2 border-primary-foreground/20  scale-x-[-1]" />
          </div>
        </div>
      </div>
    </section>
